...
def update_status(event):
    ...
    enrollment_request = json.loads(requests.get(f"http://skelechaingang-env.eba-i65amzvv.us-west-2.elasticbeanstalk.com/enrollment-status/{request_id}/").text)
    ...
    response = requests.post(
        f"http://skelechaingang-env.eba-i65amzvv.us-west-2.elasticbeanstalk.com/enrollment-status/{request_id}/",
